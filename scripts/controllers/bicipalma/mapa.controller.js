(function () {
	...
	.controller('Bicipalma.MapaController', ['TokenService', '$scope', 'DataFactory', 'uiGmapGoogleMapApi', function Controller(TokenService, $scope, DataFactory, uiGmapGoogleMapApi) {
		var vm = this;
		...
		function initController() {
			$scope.mapas = [];
			console.log('Bicipalma.MapaController loaded');
